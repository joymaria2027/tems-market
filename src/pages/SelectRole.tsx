...
const SelectRole = () => {
  ...
  const [selected, setSelected] = useState<"customer" | "affiliate" | null>(
    null,
  );
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
          ...
          >
            <div>
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Browse products, discover deals, and buy from local Gambian
                vendors.
              </p>
            </div>
            {selected === "customer" && (
          ...
          >
            <div>
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                Promote vendor products, share affiliate links, and earn
                commission payouts.
              </p>
            </div>
            {selected === "affiliate" && (
